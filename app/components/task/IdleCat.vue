<template>
  <div class="flex flex-col items-center gap-3 py-10 select-none">
    <div class="speech-bubble px-4 py-3 rounded-lg max-w-xs text-center">
      <p class="text-accent font-semibold">Alors, on glande ?</p>
      <p class="text-muted text-sm">
        C'est pas le moment de rien foutre. Choisis une tâche.
      </p>
    </div>
    ...
    <svg
      ...
      class="w-40 h-auto"
      role="img"
      aria-label="Chat noir qui regarde l'utilisateur d'un air désapprobateur"
    >
      ...
      <g class="cat-eyes" style="transform-origin: 120px 108px;">
        <ellipse cx="98" cy="108" rx="14" ry="18" fill="var(--color-accent)" />
        <ellipse cx="142" cy="108" rx="14" ry="18" fill="var(--color-accent)" />
        <rect x="95" y="98" width="6" height="24" rx="3" fill="var(--color-bg)" />
        <rect x="139" y="98" width="6" height="24" rx="3" fill="var(--color-bg)" />
      </g>
